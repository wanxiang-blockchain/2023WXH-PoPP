 ...
 *
 * @notice This is the standard interface for all PoPP-compatible FollowModules.
 */
interface IFollowModule {
    /**
     * @notice Initializes a follow module for a given PoPP profile. This can only be called by the hub contract.
     *
    ...
    /**
     * @notice Processes a given follow, this can only be called from the PoPPHub contract.
     *
     ...
     * only be called from the PoPPHub contract.
     *
