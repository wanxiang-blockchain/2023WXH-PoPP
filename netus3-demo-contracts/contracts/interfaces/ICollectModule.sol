...
interface ICollectModule {
     ...
     *
     * @param referrerProfileId The PoPPHub profile token ID of the referrer's profile (only different in case of mirrors).
     * @param collector The collector address.
     * @param profileId The token ID of the profile associated with the publication being collected.
     * @param pubId The PoPPHub publication ID associated with the publication being collected.
